import RNCoins from '@/public/assets/RNCoins.png';
...
export default function CTA(){
	return (
		<div
			className='grid grid-cols-1 lg:px-40 lg:pb-20 lg:grid-cols-2 bg-[url("../public/assets/CTABG.png");] bg-no-repeat bg-cover'>
			<div>
